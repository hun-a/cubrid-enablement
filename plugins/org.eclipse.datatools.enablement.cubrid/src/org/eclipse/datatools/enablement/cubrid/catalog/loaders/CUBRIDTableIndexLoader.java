...
import org.eclipse.datatools.enablement.cubrid.catalog.CUBRIDCatalogIndex;
...
public class CUBRIDTableIndexLoader extends JDBCTableIndexLoader {

	public CUBRIDTableIndexLoader() {
		super(null, null);
	}
	...
	public void loadIndexes(List containmentList, Collection existingIndexes)
		...
		try {
			initActiveFilter();
			Index index = null;
			PrimaryKey pk = ((CUBRIDCatalogTable)this.getTable()).getPrimaryKey();
